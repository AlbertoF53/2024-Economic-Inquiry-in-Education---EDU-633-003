...
plot <- table302_1_hs_enrollment |> 
  mutate(tooltip_label = glue::glue("Institution: {institution}<br>Year: {year}<br>Enrollment: {percent}%")) |> 
  ...
  geom_text(x = 2018.3, y = 55, label = "COVID-19", color = "#E69F00", size = 3.5) +
  geom_text(x = 2012.5, y = 71, label = "Overall", color = "grey9", size = 3.5) +
